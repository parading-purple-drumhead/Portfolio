  ...
  return (
    <div className="footer">
      <div className="social-icons mx-auto mb-10 flex w-1/5 justify-between gap-5">
        ...
        <a href="mailto:sudhanshubroy@gmail.com" className="social-icon">
          <svg
            ...
            viewBox="0 0 24 24"
            fill="currentColor"
            className="size-10 hover:animate-bounce"
          >
        ...
        {/* LinkedIn */}
        <a
          href="https://www.linkedin.com/in/sudhanshu-basuroy/"
          target="_blank"
        ...
        {/* GitHub */}
        <a
          href="https://github.com/parading-purple-drumhead"
          target="_blank"
          className="social-icon"
        >
          <svg
      ...
      <p className="uppercase text-slate-500">
        Sudhanshu Basuroy <span className="text-pink-500">&copy; 2024 </span>
      </p>
    </div>
  );
};
